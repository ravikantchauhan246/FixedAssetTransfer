...
namespace FixedAssetTransfer.Migrations
{
    ...
    [Migration("20250417062732_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetTransfer", b =>
                {
                    ...
                    b.Property<DateTime?>("AccountantSignOffDate")
                    ...
                    b.Property<string>("CurrentCostCenter")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("FinanceControllerApprovalDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("NewCostCenter")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("RecipientManagerApprovalDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AssetTransfer", b =>
                {
                    b.HasOne("ApplicationUser", "Accountant")
                        .WithMany()
                        .HasForeignKey("AccountantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ApplicationUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ApplicationUser", "RejectedBy")
                        .WithMany()
                        .HasForeignKey("RejectedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ApplicationUser", "Requestor")
                        .WithMany()
